...
import { ArrowLeft, Users, Map, Tractor, TrendingUp } from 'lucide-react';
...
const PublicDashboard = () => {
  ...
  const [filter, setFilter] = useState('semua'); // semua, pertanian, peternakan
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatCard 
            ...
            value={`${mockStats.totalTernak} Ekor`} 
            subtitle="Sapi, Kambing, Ayam, dll"
            icon={Tractor} 
            colorClass="bg-earth-50 text-earth-600" 
          />
          <StatCard 
            title="Estimasi Panen Bulan Ini" 
            value={`${mockStats.estimasiPanen} Ton`} 
            subtitle="Prediksi hasil gabungan"
            icon={TrendingUp} 
